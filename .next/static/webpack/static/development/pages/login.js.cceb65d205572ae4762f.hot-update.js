...
var useForm = function useForm(callback) {
  ...
  var handleSubmit = function handleSubmit(event) {
    ...
    console.log(values);
    console.log('******************');
    axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("http://localhost:8080/signup/").then(function (res) {
      console.log(res);
    });
    event.target.value = '';
    callback();
...
//# sourceMappingURL=login.js.cceb65d205572ae4762f.hot-update.js.map