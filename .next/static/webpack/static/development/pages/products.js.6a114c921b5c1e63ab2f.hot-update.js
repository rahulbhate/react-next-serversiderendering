...
function Products(_ref) {
  ...
  var _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_5__["useState"])(storeProducts),
  ...
  function fetchMoreListItems() {
    isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_6___default()("http://localhost:8000/products?start=".concat(start, "&limit=").concat(limit)).then(function (data) {
      var dd = {};
      dd = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_3__["default"])("dd"), data.json());
      setTimeout(function () {
        setListItems(function (prevState) {
          return [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(prevState), Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(dd));
        });
        setIsFetching(false);
      }, 3000);
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          limit = 3;
          _context.next = 4;
          return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_6___default()("http://localhost:8000/products?start=".concat(start, "&limit=").concat(limit));
...
//# sourceMappingURL=products.js.6a114c921b5c1e63ab2f.hot-update.js.map