...
function Products(_ref) {
  ...
  var _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(storeProducts),
  ...
  function fetchMoreListItems() {
    ...
    setStart(newStart);
    isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()("http://localhost:8000/products?start=".concat(start, "&limit=").concat(limit)).then(function (data) {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          limit = 3;
          _context.next = 4;
          return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()("http://localhost:8000/products?start=".concat(start, "&limit=").concat(limit));
...
//# sourceMappingURL=products.js.7fccffafe5a601479bda.hot-update.js.map