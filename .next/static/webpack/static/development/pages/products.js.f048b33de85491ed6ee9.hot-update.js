...
function Products(_ref) {
  ...
  function fetchMoreListItems() {
    ...
    isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_5___default()("http://localhost:8000/products?start=".concat(start, "&limit=").concat(limit)).then(function (data) {
      setNewProds(data.json());
      setListItems(function (prevState) {
        return [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(prevState), Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(newProds));
      });
      setIsFetching(false);
...
//# sourceMappingURL=products.js.f048b33de85491ed6ee9.hot-update.js.map